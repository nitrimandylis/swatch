...
|---|---|---|
| Hero | fastfetch | batman ANSI logo + specs, sitting top-left |
...
- jazz — my bun CLI pointing at `batman-jazz.mp4`. If it plays video/ASCII in
  the terminal it's a one-of-a-kind pane. Takes a video arg.
